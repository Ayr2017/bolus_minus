...
#[AllowDynamicProperties] class InseminationMethodTest extends TestCase
{
    use RefreshDatabase;

    public function test_fillable_matches_table_columns()
    {
        $tableColumns = Schema::getColumnListing('insemination_methods');
        $fillable = (new InseminationMethod())->getFillable();
    ...
    public function test_mass_assignment()
    {
        ...
        $result = InseminationMethod::create($data);
    ...
    public function test_create()
    {
        ...
        InseminationMethod::create($data);
    ...
    {
        $result = InseminationMethod::create([
            'name' => 'Test Name',
        ]);

        $found = InseminationMethod::find($result->id);
    ...
    public function test_update()
    {
        ...
        $this->assertDatabaseHas('insemination_methods', [
            'name' => 'Updated Name',
            'description' => 'Updated Description',
            'is_active' => false
        ]);
    ...
    public function test_delete()
    {
        ...
        $this->assertDatabaseMissing('insemination_methods', [
            'id' => $result->id,
        ]);
    }
    ...
    {
        InseminationMethod::create(['name' => 'Test Name']);
    ...
    {
        $this->expectException(QueryException::class);
        InseminationMethod::create(['name' => null]);
    }
    ...
    {
        $result = InseminationMethod::factory()->create();
