...
#[AllowDynamicProperties] class BreedingBullsControllerTest extends TestCase
{
    ...
    //     // TODO: уточнить, может ли пользователь создать запись
    //     $data = [
    //         'type' => 'Test Type',
    //         'rshn_id' => 'Test RSHN ID',
    //         'nickname' => 'Test Nickname',
    ...
    public function test_update_for_admin()
    {
        ...
        $updatedData = [
            ...
            'coat_color_id' => 2, // TODO: не обновился в бд, исправить UpdateBreedingBullRequest
            'breed_id' => 2,
            'is_selected' => false,
            'is_active' => false, // TODO: не обновился в бд, исправить UpdateBreedingBullRequest
            'is_own' => false,
        ];
