...
#[AllowDynamicProperties] class UserControllerTest extends TestCase
{
    ...
    public function test_show_for_admin()
    {
        ...
        $response = $this->actingAs($this->admin)->json('GET', route('api.users.show', $animalGroup), ['animal_group' => $animalGroup->id]);
    ...
    public function test_show_for_non_admin()
    {
        ...
        $response = $this->actingAs($this->user)->json('GET', route('api.users.show', $animalGroup), ['animal_group' => 1]);
    ...
    public function test_update_for_admin()
    {
        ...
        $response = $this->actingAs($this->admin)->putJson(route('api.users.update', $animalGroup->id), $data);
    ...
    public function test_update_for_non_admin()
    {
        ...
        $response = $this->actingAs($this->user)->putJson(route('api.users.update', $animalGroup->id), $data);
    ...
    public function test_destroy_for_admin()
    {
        ...
        $response = $this->actingAs($this->admin)->deleteJson(route('api.users.destroy', $animalGroup->id));
    ...
    public function test_destroy_forbidden_for_non_admin()
    {
        ...
        $response = $this->actingAs($this->user)->deleteJson(route('api.users.destroy', $animalGroup->id));
        $response->assertForbidden();
